...
/**
 * Servlet implementation class userdata1
 */
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			if(nm.equals("admin")&&pass.equals("admin"))
			{
				...
				RequestDispatcher rd=request.getRequestDispatcher("nodalinter.jsp");
			...
			else
			{
				...
				RequestDispatcher rd=request.getRequestDispatcher("nodallogin.jsp");
